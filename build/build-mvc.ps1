...
$webMvcFolder = Join-Path $slnFolder "src/PlaygroundDemo.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/PlaygroundDemo.Web.Public"
...
dotnet restore PlaygroundDemo.Web.sln
