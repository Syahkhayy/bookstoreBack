...
using PlaygroundDemo.MultiTenancy.HostDashboard;
...
namespace PlaygroundDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PlaygroundDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
