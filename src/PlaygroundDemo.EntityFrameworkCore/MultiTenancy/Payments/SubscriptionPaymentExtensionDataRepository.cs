...
using PlaygroundDemo.EntityFrameworkCore.Repositories;

namespace PlaygroundDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : PlaygroundDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<PlaygroundDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
