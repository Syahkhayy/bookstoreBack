...
{
    public class SubscriptionPaymentRepository : PlaygroundDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<PlaygroundDemoDbContext> dbContextProvider)
