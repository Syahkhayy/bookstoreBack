...
namespace PlaygroundDemo.Migrations
{
    ...
    [Migration("20231003035908_Added_PbBook_And_PbAuthor")]
    partial class Added_PbBook_And_PbAuthor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.Property<int>("CollaboratedBooksId")
                        .HasColumnType("int");

                    b.Property<int>("CollaboratorsId")
                        .HasColumnType("int");

                    b.HasKey("CollaboratedBooksId", "CollaboratorsId");
            ...
            modelBuilder.Entity("PlaygroundDemo.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PlaygroundDemo.Bookstore.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PlaygroundDemo.Bookstore.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PlaygroundDemo.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PlaygroundDemo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PlaygroundDemo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("PlaygroundDemo.Bookstore.Book", null)
                        .WithMany()
                        .HasForeignKey("CollaboratedBooksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PlaygroundDemo.Bookstore.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PlaygroundDemo.Bookstore.Book", b =>
                {
                    b.HasOne("PlaygroundDemo.Bookstore.Author", "Author")
                        .WithMany("Books")
