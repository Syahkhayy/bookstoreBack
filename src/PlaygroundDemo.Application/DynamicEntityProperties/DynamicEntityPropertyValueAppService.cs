...
using PlaygroundDemo.DynamicEntityPropertyValues.Dto;
...
namespace PlaygroundDemo.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : PlaygroundDemoAppServiceBase, IDynamicEntityPropertyValueAppService
    {
