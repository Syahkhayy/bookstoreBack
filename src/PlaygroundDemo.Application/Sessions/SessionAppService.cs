...
{
    public class SessionAppService : PlaygroundDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = PlaygroundDemoConsts.Currency,
                    CurrencySign = PlaygroundDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = PlaygroundDemoConsts.AllowTenantsToChangeEmailSettings,
