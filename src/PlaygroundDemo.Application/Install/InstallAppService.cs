...
using PlaygroundDemo.Configuration.Host.Dto;
...
using PlaygroundDemo.Migrations.Seed.Host;
...
namespace PlaygroundDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PlaygroundDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PlaygroundDemoDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{PlaygroundDemoConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{PlaygroundDemoConsts.ConnectionStringName}", constring);
        }
