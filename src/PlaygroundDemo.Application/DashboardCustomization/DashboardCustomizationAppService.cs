...
using PlaygroundDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace PlaygroundDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : PlaygroundDemoAppServiceBase, IDashboardCustomizationAppService
    {
