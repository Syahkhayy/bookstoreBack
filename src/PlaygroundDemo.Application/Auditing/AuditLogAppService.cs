...
using PlaygroundDemo.Auditing.Exporting;
...
using EntityHistoryHelper = PlaygroundDemo.EntityHistory.EntityHistoryHelper;

namespace PlaygroundDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PlaygroundDemoAppServiceBase, IAuditLogAppService
    {
