...
namespace PlaygroundDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(PlaygroundDemoWebCoreModule)
    )]
    public class PlaygroundDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PlaygroundDemoWebFrontEndModule(IWebHostEnvironment env, PlaygroundDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PlaygroundDemoWebFrontEndModule).GetAssembly());
        }
    }
}
