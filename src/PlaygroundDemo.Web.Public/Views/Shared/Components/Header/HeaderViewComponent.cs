...
using PlaygroundDemo.Web.Public.Startup;
using PlaygroundDemo.Web.Session;

namespace PlaygroundDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PlaygroundDemoViewComponent
    {
