...
using PlaygroundDemo.Core.Base;
using PlaygroundDemo.Core.Extensions;
using PlaygroundDemo.Dto;
using PlaygroundDemo.Types;

namespace PlaygroundDemo.Queries
{
    public class OrganizationUnitQuery : PlaygroundDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
