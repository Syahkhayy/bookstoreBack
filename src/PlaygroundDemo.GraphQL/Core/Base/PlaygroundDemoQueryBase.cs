...
namespace PlaygroundDemo.Core.Base
{
    public abstract class PlaygroundDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected PlaygroundDemoQueryBase(string fieldName,
