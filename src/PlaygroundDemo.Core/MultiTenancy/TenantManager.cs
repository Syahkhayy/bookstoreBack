...
using PlaygroundDemo.MultiTenancy.Demo;
...
namespace PlaygroundDemo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(PlaygroundDemoConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(PlaygroundDemoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
