...
{
    public class StripeGatewayManager : PlaygroundDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "PlaygroundDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + PlaygroundDemoConsts.Currency;
        }
