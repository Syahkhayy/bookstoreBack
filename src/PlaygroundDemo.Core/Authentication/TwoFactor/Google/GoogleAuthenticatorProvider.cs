...
namespace PlaygroundDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PlaygroundDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("PlaygroundDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
