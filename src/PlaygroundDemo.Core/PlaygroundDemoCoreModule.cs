...
using PlaygroundDemo.Authorization.Ldap;
...
using PlaygroundDemo.DashboardCustomization.Definitions;
using PlaygroundDemo.Debugging;
using PlaygroundDemo.DynamicEntityProperties;
using PlaygroundDemo.Features;
using PlaygroundDemo.Friendships;
using PlaygroundDemo.Friendships.Cache;
using PlaygroundDemo.Localization;
using PlaygroundDemo.MultiTenancy;
using PlaygroundDemo.Net.Emailing;
using PlaygroundDemo.Notifications;
using PlaygroundDemo.WebHooks;
using Newtonsoft.Json;

namespace PlaygroundDemo
{
    [DependsOn(
        typeof(PlaygroundDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class PlaygroundDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            PlaygroundDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = PlaygroundDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, PlaygroundDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<PlaygroundDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PlaygroundDemoCoreModule).GetAssembly());
        }
