...
using PlaygroundDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace PlaygroundDemo.Web.Startup
{
    ...
    public class PlaygroundDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PlaygroundDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PlaygroundDemoWebHostModule).GetAssembly());
        }
