...
using PlaygroundDemo.Commands;
using PlaygroundDemo.Core.Threading;
using PlaygroundDemo.Models.NavigationMenu;
using PlaygroundDemo.Services.Navigation;
using PlaygroundDemo.ViewModels.Base;
using Plugin.Media;
...
using PlaygroundDemo.ApiClient;
using PlaygroundDemo.Controls;
using PlaygroundDemo.Dto;
using PlaygroundDemo.Extensions;
using PlaygroundDemo.Localization;
using PlaygroundDemo.UI;
using PlaygroundDemo.UI.Assets;
using PlaygroundDemo.Views;
using DependencyResolver = PlaygroundDemo.Core.Dependency.DependencyResolver;

namespace PlaygroundDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "PlaygroundDemo";
