...
using PlaygroundDemo.Authentication.TwoFactor;
...
using PlaygroundDemo.Web.Authentication.JwtBearer;
using PlaygroundDemo.Web.Authentication.TwoFactor;
using PlaygroundDemo.Web.Chat.SignalR;
using PlaygroundDemo.Web.Configuration;
using PlaygroundDemo.Web.DashboardCustomization;

namespace PlaygroundDemo.Web
{
    [DependsOn(
        typeof(PlaygroundDemoApplicationModule),
        typeof(PlaygroundDemoEntityFrameworkCoreModule),
    ...
    public class PlaygroundDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PlaygroundDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(PlaygroundDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PlaygroundDemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(PlaygroundDemoWebCoreModule).Assembly);
        }
